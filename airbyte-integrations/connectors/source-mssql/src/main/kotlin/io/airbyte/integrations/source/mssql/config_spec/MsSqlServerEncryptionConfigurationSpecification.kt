...
sealed interface MsSqlServerEncryptionConfiguration

@JsonSchemaTitle("Unencrypted")
@JsonSchemaDescription(
    "Data transfer will not be encrypted.",
)
data object EncryptionDisabled : MsSqlServerEncryptionConfiguration

@JsonSchemaTitle("Encrypted (trust server certificate)")
@JsonSchemaDescription(
    "Use the certificate provided by the server without verification. (For testing purposes only!)"
)
data object EncryptionRequiredTrustServerCertificate : MsSqlServerEncryptionConfiguration
...
class SslVerifyCertificate : MsSqlServerEncryptionConfiguration {
...
class MicronautPropertiesFriendlyMsSqlServerEncryption {
    ...
    @JsonValue
    fun asEncryption(): MsSqlServerEncryptionConfiguration =
        when (mode) {
