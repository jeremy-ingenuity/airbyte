...
import io.airbyte.integrations.source.mssql.config_spec.MicronautPropertiesFriendlyMsSqlServerEncryption
import io.airbyte.integrations.source.mssql.config_spec.MicronautPropertiesFriendlyMsSqlServerReplicationMethodConfiguration
import io.airbyte.integrations.source.mssql.config_spec.MsSqlServerEncryptionConfiguration
import io.airbyte.integrations.source.mssql.config_spec.MsSqlServerReplicationMethodConfiguration
...
class NsSqlServerSourceConfigurationSpecification : ConfigurationSpecification() {
    @JsonProperty("host")
    ...
    @JsonIgnore var encryptionJson: MsSqlServerEncryptionConfiguration? = null
    @JsonSetter("ssl_method")
    fun setEncryptionValue(value: MsSqlServerEncryptionConfiguration) {
    ...
    fun getEncryptionValue(): MsSqlServerEncryptionConfiguration? =
        encryptionJson ?: encryption.asEncryption()

    @JsonIgnore
    @ConfigurationBuilder(configurationPrefix = "method")
    var replicationMethod = MicronautPropertiesFriendlyMsSqlServerReplicationMethodConfiguration()
    @JsonIgnore var replicationMethodJson: MsSqlServerReplicationMethodConfiguration? = null
    @JsonSetter("replication_method")
    fun setReplicationMethodValue(value: MsSqlServerReplicationMethodConfiguration) {
